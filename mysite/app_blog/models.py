...
class Category(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = u'Категорія для публікації'
...
class Article(models.Model):
    title = models.CharField(u'Заголовок', max_length=250, help_text=u'Максимум 250')

    description = models.TextField(blank=True, verbose_name=u'Опис')

    pub_date = models.DateTimeField(blank=True, verbose_name=u'Дата публікації', default=timezone.now)
